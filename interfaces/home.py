...
class HomeInterface(tk.Frame):
    ...
    def __init__(self, master, controller):
        ...
        lbl_I_Desc = tk.Label(infoFrame, text=" The starting Infected (I) population count. The reccomended and default value is 1.", font=("Arial", 10), bg="#654e78")
        ...
        lbl_IrPsu_Desc = tk.Label(infoFrame, text=" The rate of a successful connection to an S Node, per scan, for Random-Scanning (IR).", font=("Arial", 10), bg="#654e78")
        ...
        lbl_IlPsu_Desc = tk.Label(infoFrame, text=" The rate of a successful connection to an S Node, per scan, for Local-Scanning (IL).", font=("Arial", 10), bg="#654e78")
        ...
        lbl_IpPsu_Desc = tk.Label(infoFrame, text=" The rate of a successful connection to an S Node, per scan, for Peer-to-Peer (IP).", font=("Arial", 10), bg="#654e78")
        ...
        lbl_PTrns_Desc = tk.Label(infoFrame, text=" The rate of a successful transmission of infection, per successful I Node contact to an S Node.", font=("Arial", 10), bg="#654e78")
        ...
        lbl_configuration_list.place(x=290, y=40)
        ...
        lbl_compare_model_list.place(x=241, y=470)
