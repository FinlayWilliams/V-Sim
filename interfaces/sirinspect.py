...
class SIRInspectInterface(tk.Frame):
    ...
    def __init__(self, master, controller):
        ...
        btnReturn = tk.Button(controlBar, wraplength=41, width=7, text="Return Home", font=("Arial", 7),
                              relief="ridge", fg="white", bg="#6e6e6e",
                               command=lambda: controller.display("SIRInspectInterface", "HomeInterface"))
        ...
        lblLegend2 = tk.Label(mainFrame, bg="#d62728", width=25, pady=4, text="(I) Infected",
                              font=("Arial", 9), fg="white")
        lblLegend3 = tk.Label(mainFrame, bg="#1f77b4", width=27, pady=4, text="(R) Recovered",
                              font=("Arial", 9), fg="white")
        ...
        btnConfigure = tk.Button(graphFrame, wraplength=41, width=7, text="Configure Model", font=("Arial", 7),
                                 relief="ridge", fg="white", bg="#6e6e6e",
                                 command=lambda: controller.display("SIRInspectInterface", "SIRControlInterface"))
    ...
    def updateGraphs(self):
        ...
        self.ax[1].set_title("Population Sizes on Final Recorded Day #{}".format(self.controller.activeModel.Timesteps))
    ...
    def populateOverview(self, model):
        pass

    def populatePopulationFrame(self, model):
        pass

    def populateBetaFrame(self, model):
        pass

    def populateGammaFrame(self, model):
        pass

    def populateMiscFrame(self, model):
        pass
