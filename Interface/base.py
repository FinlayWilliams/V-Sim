...
class BaseInterface:
    ...
    def __init__(self):
        ...
        self.modelList = []
        self.initialiseBaseInterfaceObjects()

    # This method initialises the base window itself
    def initialiseBaseInterfaceObjects(self):
        ...
        self.btn2 = tk.Button(self.otherInterface.frame_1, text="BAZINGA", command=self.displayInterface)

        self.currentInterface = controls.ControlInterface()
        self.currentInterface.displayModelControls(self.base)
        self.btn1 = tk.Button(self.currentInterface.frame_1, text="hi", command=self.clearInterface)
        self.btn1.pack()
